    ...
    <section className="min-h-screen flex items-center justify-center pt-20 px-4">
      <div className="container mx-auto max-w-4xl text-center animate-fade-up">
        ...
        <div className="flex items-center justify-center gap-4">
          ...
          <a href="Madhu_Mathi_Resume.docx" target="_blank">
    Download Resume
</a>" download className="px-6 py-3 rounded-md border border-border text-foreground font-semibold hover:border-primary hover:text-primary transition-all flex items-center gap-2">
